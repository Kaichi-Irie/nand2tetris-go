...
# rename docs/pkg/nand2tetris-golang/index.html?m=all.html to docs/pkg/nand2tetris-golang/index.html
mv -f docs/pkg/nand2tetris-golang/index.html?m=all.html docs/pkg/nand2tetris-golang/index.html
