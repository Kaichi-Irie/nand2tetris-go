...
## Nand2Tetrisとは
　Nand2Tetrisは，Nandゲートから始めて，論理ゲート、加算器、CPUを設計します。そして、アセンブラ、仮想マシン、コンパイラ、OSなどを実装しコンピュータを完成させて、最後にその上でアプリケーション（テトリスなど）を動作させるというプロジェクトです．
...
　プロジェクトの概要については，公式のCourse Promoがとてもわかりやすいです．
